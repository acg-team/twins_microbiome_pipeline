...
source("src/twin_analysis/1_metadata.R")
source("src/2_file_names_parsing.R")

print("==================> long dada2 analysis has started...")
source("src/twin_analysis/3_BIG_dada_SV_table.R")

print("==================> Taxonomy assignment has started...")
source("src/twin_analysis/4_Tax_Assign.R")

print("==================> Phylogeny reconstraction has started...")
source("src/twin_analysis/5_Phylogeny.R")

source("src/twin_analysis/6_Create_Phyloseq_obj.R")
